    ...
    def _one_page_overflow_feedback(
        ...
        *,
        ...
        return (
            ...
            f"You MUST reduce the content by roughly {suggested_trim} lines total so it fits exactly on one page.\n"
    ...
    async def generate_latex_resume(
        ...
        *,
        ...
        prompt = (
            ...
            f"TARGET JOB: {role_label} at {company}\n\n"
            "Do not default to minimal edits.\n\n"
            "RULES:\n"
    ...
    async def generate_latex_cover_letter(
        ...
        *,
        ...
        prompt = (
            ...
            f"DATE: {today_label}\n\n"
            "Update the recipient block and subject so they clearly reference the target company and role.\n"
            "Replace outdated academic or unrelated recipient/subject text if present in the template.\n\n"
            "RULES:\n"
            ...
            "4. Write exactly 3 substantive body paragraphs. COMPLETELY REWRITE all body paragraphs in FIRST PERSON (I/my/me):\n"
